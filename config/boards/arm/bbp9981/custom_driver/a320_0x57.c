...
#include <zmk/events/position_state_changed.h> /* ★ 新增：监听 position 事件 */
#include <zmk/hid.h>
...
/* ==== Ctrl 判断：当 position=37 且按下时 true ==== */
static bool ctrl_pressed = false;

/* ==== position_state_changed 事件监听 ==== */
static int ctrl_listener_cb(const zmk_event_t *eh) /* ★ 修改这里 */
{
